...
const orchestration_execute_result_1 = require("./orchestration-execute-result");
...
class OrchestrationExecutor {
    ...
    async execute(instanceId, oldEvents, newEvents) {
        ...
        return new orchestration_execute_result_1.OrchestrationExecuteResult(actions, ctx._customStatus);
    }
