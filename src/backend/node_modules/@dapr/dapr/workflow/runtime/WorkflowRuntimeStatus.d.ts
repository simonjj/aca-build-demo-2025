 ...
 */
export declare enum WorkflowRuntimeStatus {
    RUNNING = 0,
    COMPLETED = 1,
    FAILED = 3,
    TERMINATED = 5,
 ...
 */
export declare function fromOrchestrationStatus(val: OrchestrationStatus): WorkflowRuntimeStatus;
/**
 ...
 */
export declare function toOrchestrationStatus(val: WorkflowRuntimeStatus): OrchestrationStatus;
